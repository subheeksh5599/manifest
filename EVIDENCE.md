...
Rust tests, **25** receipt checks, **5** hostile checks.
...
| Every fee figure is re-derived from raw account bytes by a second implementation | stdout, 25 checks | `python3 scripts/verify_receipts.py --check` |
